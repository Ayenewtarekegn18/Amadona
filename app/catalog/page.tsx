        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="grow max-w-md">
              <div className="relative">
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 border border-subtle rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-700 bg-card text-app"
                  value={searchTerm}
            ...
            <div className="flex flex-wrap gap-4">
                <select
                  className="px-4 py-2 border border-subtle rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-700 bg-card text-app"
                  value={filters.type}
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <button
                    ...
                    className="w-full bg-purple-800 text-white px-4 py-2 rounded-xl hover:bg-purple-900 transition-colors"
                  >
                    View Details
                  </button>
                </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <button
                    ...
                    className="bg-purple-800 text-white px-6 py-2 rounded-xl hover:bg-purple-900 transition-colors"
                  >
                    Request Quote
                  </button>
                </div>
